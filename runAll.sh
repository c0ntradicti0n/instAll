...
screen -S  CorpusCook -p 0 -X stuff 'cd CorpusCook && . venv/bin/activate && python server/annotation_server.py\n'

screen -dmS AppCorpusCook
screen -S AppCorpusCook -p 0 -X stuff 'cd CorpusCookApp && . venv/bin/activate && python client_as_micviz.py\n'
